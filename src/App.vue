...
<nav class="bg-yellow border-gray-200 dark:bg-gray-900">
  ...
  <div class="flex md:order-2">
    ...
    <div class="relative hidden md:block">
      ...
      <input type="text" id="search-navbar" class="block w-full p-2 pl-10 text-sm text-gray-900 border border-mint rounded-lg bg-mint focus:ring-green focus:border-green dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search...">
    </div>
...
@import url(./assets/css/styling.css);
</style>
